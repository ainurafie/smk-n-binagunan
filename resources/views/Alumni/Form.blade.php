...
<body class="bg-[#F7F7F7]">
    ...
    <div class="lg:mt-40 mt-40 md:px-[120px] px-5">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[5px] focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        </div>
        <div class="mb-6">
        ...
        <div class="flex justify-center">
            <button class="rounded-[5px] text-white py-4 px-30" style="border-radius:5px; background-color: #2F73FE; padding-left:130px; padding-right:130px; margin-bottom:250px;" data-modal-toggle="sukses">Simpan</button>
        </div>
    </div>
